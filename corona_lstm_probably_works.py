...
#inp_arr is the input data, only the cases (y-values) not the x values
#adv is the amt of days you want to go forward
#lb is the lookback
#ep is the number of training epochs

def do_code(inp_arr, adv, lb, ep):
...
def from_csv():
    ...
    print(do_code(df["Cases"].tolist(), 10, 6, 10))
